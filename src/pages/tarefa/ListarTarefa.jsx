...
const initialRows = [
  ...
  createData(6, 'Tarefa 7', 'Descrição da Tarefa 7', '2022-01-08', '2022-01-09', 'Aguardando', 'Recurso 7'),
  createData(6, 'Tarefa 8', 'Descrição da Tarefa 8', '2022-01-09', '2022-01-10', 'Aguardando', 'Recurso 8'),
];
